...
if ticker:
    ...
    if price is None:
        st.error("Hisse fiyatı alınamadı. API sınırı aşılmış olabilir.")
    elif prices is None:
        ...
        st.markdown("📊 [Opsiyon Zinciri - Barchart](https://www.barchart.com/stocks/quotes/{}/options)".format(ticker))
